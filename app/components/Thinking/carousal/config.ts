export const images = [
  {
        ...
        src1: '/assets/images/thinking/1.jpg',
        alt: 'Project 1',
        title: 'Naved Khan',
        description:
...
export const duplicatedImages = [...images, ...images, ...images, ...images, ...images, ...images, ...images, ...images, ...images, ...images, ...images, ...images, ...images, ...images, ...images];
